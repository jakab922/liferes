...
admin.site.register(OneColumnRow)
admin.site.register(TwoColumnRow)
admin.site.register(ThreeColumnRow)
admin.site.register(EmptyRow)
admin.site.register(ThreePictureRow)
