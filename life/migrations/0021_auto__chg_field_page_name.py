...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('life_page', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))
    def backwards(self, orm):

        # Changing field 'Page.name'
        db.alter_column('life_page', 'name', self.gf('django.db.models.fields.CharField')(max_length=30))
    models = {
        'life.address': {
