...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StaffMember.position'
        db.add_column('life_staffmember', 'position',
                      self.gf('django.db.models.fields.CharField')(default='a', max_length=40),
                      keep_default=False)

        # Adding field 'StaffMember.linkedin_link'
        db.add_column('life_staffmember', 'linkedin_link',
                      self.gf('django.db.models.fields.URLField')(default='a', max_length=200),
                      keep_default=False)

        # Adding field 'StaffMember.introduction'
        db.add_column('life_staffmember', 'introduction',
                      self.gf('django.db.models.fields.TextField')(default='a'),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'StaffMember.position'
        db.delete_column('life_staffmember', 'position')

        # Deleting field 'StaffMember.linkedin_link'
        db.delete_column('life_staffmember', 'linkedin_link')

        # Deleting field 'StaffMember.introduction'
        db.delete_column('life_staffmember', 'introduction')
    ...
    models = {
        ...
        'life.staffmember': {
            ...
            'position': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
