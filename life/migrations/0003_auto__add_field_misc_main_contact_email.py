...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Misc.main_contact_email'
        db.add_column('life_misc', 'main_contact_email',
                      self.gf('django.db.models.fields.EmailField')(default=1, max_length=75),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Misc.main_contact_email'
        db.delete_column('life_misc', 'main_contact_email')
